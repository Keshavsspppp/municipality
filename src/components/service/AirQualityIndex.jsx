      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Air Quality Index Submission</h1>
            <p className="mt-2 text-gray-600">Submit data for air quality monitoring</p>
          </div>
          ...
          {step === 1 ? (
            ...
            >
              <div className="p-6 text-center">
                ...
                <p className="text-gray-600 mb-6">Air quality data has been submitted successfully.</p>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  You can submit more air quality data or close this page.
                </p>
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
