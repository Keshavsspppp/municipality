...
const RTI = () => {
  ...
  const [applicationFee, setApplicationFee] = useState(10);
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Right to Information (RTI) Application</h1>
            <p className="mt-2 text-gray-600">File an application to request information under the RTI Act</p>
          </div>
          ...
          {step === 1 ? (
              ...
              <div className="p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                   ...
                   <div>
                    <label htmlFor="informationDetails" className="block text-sm font-medium text-gray-700">
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      placeholder="Clearly specify the information you are requesting"
                    />
                  </div>
                   ...
                   <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-gray-900">RTI Application</dd>
                      </div>
                      <div>
            ...
            >
              <div className="p-6 text-center">
                ...
                <p className="text-gray-600 mb-6">Your RTI application has been submitted successfully.</p>
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">RTI{Math.floor(Math.random() * 1000000)}</dd>
                    </div>
                    <div>
                     ...
                     <div>
                      <dt className="text-sm font-medium text-gray-500">Application Fee Paid</dt>
                      <dd className="mt-1 text-sm text-gray-900">₹{applicationFee}</dd>
                    </div>
                  </dl>
                </div>
                <p className="text-sm text-gray-500 mb-6">
                  We will process your application and provide the information as per the RTI Act guidelines.
                </p>
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
