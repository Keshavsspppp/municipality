      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">New Water Connection</h1>
            <p className="mt-2 text-gray-600">Apply for a new water connection</p>
          </div>
          ...
          {step === 1 ? (
            ...
            >
              <div className="p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="existingConnection" className="block text-sm font-medium text-gray-700">
                      Existing Connection
                    </label>
                    <select
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div className="space-y-1 text-center">
                        ...
                        <p className="text-xs text-gray-500">
                          Property documents, ID proof, and address proof
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              <div className="p-6 text-center">
                ...
                <p className="text-gray-600 mb-6">Your water connection application has been submitted successfully.</p>
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">WC{Math.floor(Math.random() * 1000000)}</dd>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">{formData.connectionType}</dd>
                    </div>
                    <div>
