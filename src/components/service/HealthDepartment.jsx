      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Health Department Services</h1>
            <p className="mt-2 text-gray-600">Apply for health certificates or report health concerns</p>
          </div>
          ...
          {step === 1 ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    >
                      ...
                      <option value="health_certificate">Health Certificate Application</option>
                      <option value="report_concern">Report a Health Concern</option>
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                         ...
                         <p className="text-xs text-gray-500">
                          Medical reports, photos, or other relevant documents
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              <div className="p-6 text-center">
                ...
                <p className="text-gray-600 mb-6">Your request has been submitted successfully to the Health Department.</p>
                  ...
                  <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                     ...
                     <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">HD{Math.floor(Math.random() * 1000000)}</dd>
                    </div>
                  </dl>
                </div>
                <p className="text-sm text-gray-500 mb-6">
                  We will review your submission and contact you if necessary.
                </p>
                <button
                  onClick={() => setStep(1)}
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
